...
// 角度をデグリー変換
//===================================================
D3DXVECTOR3 math::ToDegree(const D3DXVECTOR3& rot)
{
	return rot * (180.0f / D3DX_PI);
}

//===================================================
// 角度をラジアン変換
//===================================================
D3DXVECTOR3 math::ToRadian(const D3DXVECTOR3& rot)
{
	return rot * (D3DX_PI / 180.0f);
}
...
// スナップ移動
//===================================================
float math::Snap(const float fValue, const float fGridSize)
{
	return std::roundf(fValue / fGridSize) * fGridSize;
}
