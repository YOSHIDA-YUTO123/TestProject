...
// マウスを離したら
//===============================================
bool CInputMouse::OnMouseRelease(int button_type)
{
	return m_PrevState.rgbButtons[button_type] & 0x80 && !(m_CurrentState.rgbButtons[button_type] & 0x80);
}
...
// マウスの移動量取得処理
//===============================================
D3DXVECTOR2 CInputMouse::GetPosition(void)
{
...
// マウスの過去の移動量取得処理
//===============================================
D3DXVECTOR2 CInputMouse::GetOldPosition(void)
{
...
{
	float moveX = m_CurrentState.lX - m_PrevState.lX;
	float moveY = m_CurrentState.lY - m_PrevState.lY;

	return D3DXVECTOR2(moveX, moveY);
}
