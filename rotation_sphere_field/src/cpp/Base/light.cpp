...
//
//	if (CManager::Instance().GetInputKeyboard()->GetTrigger(DIK_UP))
//	{
//		nSelect++;
//	}
//	if (CManager::Instance().GetInputKeyboard()->GetTrigger(DIK_DOWN))
//	{
//		nSelect--;
//	}
//
...
//	{
//		if (CManager::Instance().GetInputKeyboard()->GetPress(DIK_T))
//		{
//			m_Light[nSelect].Light.Direction.x += 0.01f;
//		}
//		if (CManager::Instance().GetInputKeyboard()->GetPress(DIK_Y))
//		{
//			m_Light[nSelect].Light.Direction.x -= 0.01f;
//		}
//
//		if (CManager::Instance().GetInputKeyboard()->GetPress(DIK_G))
//		{
//			m_Light[nSelect].Light.Direction.y += 0.01f;
//		}
//		if (CManager::Instance().GetInputKeyboard()->GetPress(DIK_H))
//		{
//			m_Light[nSelect].Light.Direction.y -= 0.01f;
//		}
//
//		if (CManager::Instance().GetInputKeyboard()->GetPress(DIK_B))
//		{
//			m_Light[nSelect].Light.Direction.z += 0.01f;
//		}
//		if (CManager::Instance().GetInputKeyboard()->GetPress(DIK_N))
//		{
//			m_Light[nSelect].Light.Direction.z -= 0.01f;
//		}
//
...
{
	// デバイスの取得
	LPDIRECT3DDEVICE9 pDevice = CManager::Instance().GetRenderer()->GetDevice();
